const BookingPage = ({ searchParams }: { searchParams: any }) => {
        ...
        {status === "canceled" ? (
          <>
            ...
            <p className="text-gray-600 mb-4">
              Your payment has been canceled. If this was a mistake, please try
          ...
          <>
            ...
            <p className="text-gray-600 mb-4">
              We could not determine the status of your payment. Please try
              again later.
            </p>
            <div className="mt-6">
              <a
