...
import { Globe, Users, BookOpen, Award, MapPin, Mail } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-100 rounded-lg p-8">
          ...
          <div className="flex justify-center items-center">
            <Mail className="text-blue-500 w-8 h-8 mr-4" />
            <p className="text-xl text-gray-700">
              Have questions? Reach out to us at{" "}
              <a href="mailto:info@traveltips.com" className="text-blue-600 hover:underline">
                info@traveltips.com
              </a>
            </p>
          </div>
